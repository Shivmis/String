...
async def start(client, message: Message):
    ...
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton("▪️ᴜᴘᴅᴀᴛᴇs ▪️", url="https://t.me/shivang_xd")
        ],
        [
            InlineKeyboardButton("▪️ sᴏᴜʀᴄᴇ ▪️", url="https://files.catbox.moe/s38i5o.mp4"),
            InlineKeyboardButton("▪️ ᴍᴜsɪᴄ ʙᴏᴛ ▪️", url="https://t.me/X_NETWORK_BOTS_I")
        ]
    ]
...
❍ ɪғ ʏᴏᴜ ɴᴇᴇᴅ ᴀɴʏ ʜᴇʟᴘ, ᴛʜᴇɴ ᴅᴍ ᴛᴏ ᴍʏ ᴏᴡɴᴇʀ: [⏤͟͟͞͞🥀➣- ♔ 𝐒 𝐇 𝐈 𝐕 𝐀 𝐍 𝐆 🜲 ˹ 𝐎ᴘ ˼﹛🇨🇦﹜≈ 💸➻ >•⏤͟͟͞͞‌](tg://user?id={OWNER_ID}) """,
